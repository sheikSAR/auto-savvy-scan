  ...
  return (
    <div className="min-h-screen flex flex-col dark:bg-gray-900 font-poppins">
      ...
      <main className="flex-grow">
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-5xl mx-auto text-center">
                <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
                  <span className="bg-gradient-to-r from-car-blue via-blue-600 to-teal-accent bg-clip-text text-transparent">KARE</span> V-Analyser
                </h1>
                ...
                {[
                  {
                    ...
                    description: "Upload multiple photos of the car from different angles."
                  },
                  {
                    icon: <Database className="w-8 h-8 text-car-orange" />,
                    title: "Enter Car Details",
                    description: "Provide basic information about the car model and history."
                  },
                  {
                    icon: <ShieldCheck className="w-8 h-8 text-car-green" />,
                    title: "AI Analysis",
                    description: "Our AI detects defects and verifies legal status."
                  },
                  {
                    icon: <DollarSign className="w-8 h-8 text-teal-accent" />,
                    title: "Get Price Insights",
                    description: "Receive a fair price recommendation based on condition."
                  }
                ].map((feature, index) => (
                  <div key={index} className="glass-card flex flex-col items-center text-center p-6 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
        ...
        {/* Analysis Section */}
        <section id="analysis-section" className="py-16 bg-gray-50 dark:bg-gray-800/50 relative">
          <div className="absolute inset-0 bg-tech-pattern opacity-5"></div>
          <div className="container mx-auto px-4">
                    ...
                    <React.Fragment key={item.step}>
                      ...
                      {index < arr.length - 1 && (
                        <div className={`flex-1 h-1 mx-2 transition-all ${
                          step > item.step ? 'bg-gradient-to-r from-car-blue to-teal-accent' : 'bg-gray-200 dark:bg-gray-700'
                        }`} />
                      )}
                    </React.Fragment>
                  ))}
                ...
                {[
                  {
                    ...
                    comment: "This tool saved me from buying a car with hidden damage. The AI detected issues the seller didn't disclose, and I negotiated a better price."
                  },
                  {
                    initials: "PP",
                    name: "Priya Patel",
                    role: "Car enthusiast",
                    comment: "I've bought several used cars, but this analysis is game-changing. The fair price estimation is spot-on, and the legal check saved me from paperwork headaches."
                  },
                  {
                    initials: "AG",
                    name: "Arun Gupta",
                    role: "Car dealer",
                    comment: "As a small dealership owner, this tool helps me accurately price my inventory. The detailed condition reports build trust with my customers."
                  }
